...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BookingRequest.is_completed'
        db.add_column('resource_daily_scheduler_bookingrequest', 'is_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BookingRequest.is_completed'
        db.delete_column('resource_daily_scheduler_bookingrequest', 'is_completed')
