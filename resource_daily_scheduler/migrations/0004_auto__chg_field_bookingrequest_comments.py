...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BookingRequest.comments'
        db.alter_column('resource_daily_scheduler_bookingrequest', 'comments', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'BookingRequest.comments'
        db.alter_column('resource_daily_scheduler_bookingrequest', 'comments', self.gf('django.db.models.fields.CharField')(default='', max_length=256))
    ...
    models = {
        ...
        'resource_daily_scheduler.bookingrequest': {
            ...
            'comments': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
