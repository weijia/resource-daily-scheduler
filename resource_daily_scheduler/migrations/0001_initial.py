...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BookableResource'
        db.create_table('resource_daily_scheduler_bookableresource', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('alias', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('approver', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('resource_daily_scheduler', ['BookableResource'])

        # Adding model 'BookingRequest'
        db.create_table('resource_daily_scheduler_bookingrequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_approved', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_ongoing', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('start', self.gf('django.db.models.fields.DateTimeField')()),
            ('end', self.gf('django.db.models.fields.DateTimeField')()),
            ('project', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ...
            ('approver', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='booking_request_approver', null=True, to=orm['auth.User'])),
            ('resource', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resource_daily_scheduler.BookableResource'])),
        ))
        db.send_create_signal('resource_daily_scheduler', ['BookingRequest'])


    def backwards(self, orm):
        # Deleting model 'BookableResource'
        db.delete_table('resource_daily_scheduler_bookableresource')

        # Deleting model 'BookingRequest'
        db.delete_table('resource_daily_scheduler_bookingrequest')
    ...
    models = {
        ...
        'resource_daily_scheduler.bookableresource': {
            'Meta': {'object_name': 'BookableResource'},
            'alias': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'approver': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'resource_daily_scheduler.bookingrequest': {
            'Meta': {'object_name': 'BookingRequest'},
            'approver': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'booking_request_approver'", 'null': 'True', 'to': "orm['auth.User']"}),
            ...
            'resource': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['resource_daily_scheduler.BookableResource']"}),
    ...
    complete_apps = ['resource_daily_scheduler']