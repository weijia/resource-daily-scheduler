...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BookingRequest.is_canceled'
        db.add_column('resource_daily_scheduler_bookingrequest', 'is_canceled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BookingRequest.is_canceled'
        db.delete_column('resource_daily_scheduler_bookingrequest', 'is_canceled')
